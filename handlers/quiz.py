...
async def answering_q1(message: Message, state: FSMContext):  #задание 1 вопроса
    ...
    await state.set_state(answer_the_q.ans_q1)


@router.message(answer_the_q.ans_q1, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 2 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q2)
    except IndexError:
...
@router.message(answer_the_q.ans_q2, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 3 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q3)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q3, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 4 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q4)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q4, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 5 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q5)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q5, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 6 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q6)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q6, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 7 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q7)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q7, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 8 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q8)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q8, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 9 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q9)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q9, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 10 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q10)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q10, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 11 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q11)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q11, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 12 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q12)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q12, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 13 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q13)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q13, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 14 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q14)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q14, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 15 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q15)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q15, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 16 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q16)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q16, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 17 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q17)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q17, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 18 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q18)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q18, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 19 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q19)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q19, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 20 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q20)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q20, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 21 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q21)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q21, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 22 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q22)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q22, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 23 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q23)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q23, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 24 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q24)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q24, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  # задание 25 вопроса
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q25)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q25, F.text.in_(available_answers))
async def answering_q1(message: Message, state: FSMContext):  
    ...
    try:
        ...
        await state.set_state(answer_the_q.ans_q26)
    except IndexError:
        await message.answer(text=f"{reply_after_quiz[0]}",reply_markup=ReplyKeyboardRemove())
        list_=list(user_data.values())[1:] #Сброс состояния и сохранённых данных у пользователя
        pass_user_data(str(message.from_user.id),int(available_departmemts.index(user_data['department'])),list_ )
...
@router.message(answer_the_q.ans_q1)
@router.message(answer_the_q.ans_q2)
@router.message(answer_the_q.ans_q3)
@router.message(answer_the_q.ans_q4)
@router.message(answer_the_q.ans_q5)
@router.message(answer_the_q.ans_q6)
@router.message(answer_the_q.ans_q7)
@router.message(answer_the_q.ans_q8)
@router.message(answer_the_q.ans_q9)
@router.message(answer_the_q.ans_q10)
@router.message(answer_the_q.ans_q11)
@router.message(answer_the_q.ans_q12)
@router.message(answer_the_q.ans_q13)
@router.message(answer_the_q.ans_q14)
@router.message(answer_the_q.ans_q15)
@router.message(answer_the_q.ans_q16)
@router.message(answer_the_q.ans_q17)
@router.message(answer_the_q.ans_q18)
@router.message(answer_the_q.ans_q19)
@router.message(answer_the_q.ans_q20)
@router.message(answer_the_q.ans_q21)
@router.message(answer_the_q.ans_q22)
@router.message(answer_the_q.ans_q23)
@router.message(answer_the_q.ans_q24)
@router.message(answer_the_q.ans_q25)
